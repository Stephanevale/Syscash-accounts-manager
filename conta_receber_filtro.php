...
function validaDados($registro)
{
    ...
    if (!filter_var($registro->descricao_contareceber, )) {
        $erros["descricao_contareceber"] =  "Descrição: Campo vazio e ou informação inválida!";
    }

    if (!filter_var($registro->favorecido_id_contareceber, )) {
    ...
    if (!filter_var($registro->datavencimento_contareceber, FILTER_UNSAFE_RAW )) {
        $erros["datavencimento_contareceber"] =  "Data Vencimento: Campo vazio e ou informação inválida!";
    }

    if (!filter_var($registro->categoria_id_contareceber, FILTER_UNSAFE_RAW )) {
